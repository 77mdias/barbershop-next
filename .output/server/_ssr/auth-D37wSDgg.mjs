import { a as __toCommonJS, i as __require, n as __esmMin, o as __toESM, r as __exportAll, t as __commonJSMin } from "./encryption-runtime-LT6HXFPw.mjs";
...
//#region node_modules/.nitro/vite/services/rsc/assets/logger-COnhKvI2.js
var Logger = class {
	constructor() {
...
//#endregion
//#region node_modules/.nitro/vite/services/rsc/assets/auth-D37wSDgg.js
...
var require_jwt = /* @__PURE__ */ __commonJSMin(((exports) => {
	var _interopRequireDefault$10 = __require("@babel/runtime/helpers/interopRequireDefault");
	Object.defineProperty(exports, "__esModule", { value: true });
	var _exportNames = {
		encode: true,
		decode: true,
	...
	var _jose = __require("jose");
	var _hkdf = _interopRequireDefault$10(__require("@panva/hkdf"));
	var _uuid = __require("uuid");
...
var require_errors = /* @__PURE__ */ __commonJSMin(((exports) => {
	var _interopRequireDefault$9 = __require("@babel/runtime/helpers/interopRequireDefault");
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	var _regenerator$1 = _interopRequireDefault$9(__require("@babel/runtime/regenerator"));
	var _asyncToGenerator2$1 = _interopRequireDefault$9(__require("@babel/runtime/helpers/asyncToGenerator"));
	var _defineProperty2$1 = _interopRequireDefault$9(__require("@babel/runtime/helpers/defineProperty"));
	var _classCallCheck2 = _interopRequireDefault$9(__require("@babel/runtime/helpers/classCallCheck"));
	var _createClass2 = _interopRequireDefault$9(__require("@babel/runtime/helpers/createClass"));
	var _possibleConstructorReturn2 = _interopRequireDefault$9(__require("@babel/runtime/helpers/possibleConstructorReturn"));
	var _getPrototypeOf2 = _interopRequireDefault$9(__require("@babel/runtime/helpers/getPrototypeOf"));
	var _inherits2 = _interopRequireDefault$9(__require("@babel/runtime/helpers/inherits"));
	var _wrapNativeSuper2 = _interopRequireDefault$9(__require("@babel/runtime/helpers/wrapNativeSuper"));
	...
	exports.OAuthCallbackError = function(_UnknownError) {
		function OAuthCallbackError() {
			...
			(0, _defineProperty2$1.default)(_this2, "name", "OAuthCallbackError");
			return _this2;
		}
	...
	exports.AccountNotLinkedError = function(_UnknownError2) {
		function AccountNotLinkedError() {
			...
			(0, _defineProperty2$1.default)(_this3, "name", "AccountNotLinkedError");
			return _this3;
		}
	...
	exports.MissingAPIRoute = function(_UnknownError3) {
		function MissingAPIRoute() {
			...
			(0, _defineProperty2$1.default)(_this4, "name", "MissingAPIRouteError");
			(0, _defineProperty2$1.default)(_this4, "code", "MISSING_NEXTAUTH_API_ROUTE_ERROR");
			return _this4;
		}
	...
	exports.MissingSecret = function(_UnknownError4) {
		function MissingSecret() {
			...
			(0, _defineProperty2$1.default)(_this5, "name", "MissingSecretError");
			(0, _defineProperty2$1.default)(_this5, "code", "NO_SECRET");
			return _this5;
		}
	...
	exports.MissingAuthorize = function(_UnknownError5) {
		function MissingAuthorize() {
			...
			(0, _defineProperty2$1.default)(_this6, "name", "MissingAuthorizeError");
			(0, _defineProperty2$1.default)(_this6, "code", "CALLBACK_CREDENTIALS_HANDLER_ERROR");
			return _this6;
		}
	...
	exports.MissingAdapter = function(_UnknownError6) {
		function MissingAdapter() {
			...
			(0, _defineProperty2$1.default)(_this7, "name", "MissingAdapterError");
			(0, _defineProperty2$1.default)(_this7, "code", "EMAIL_REQUIRES_ADAPTER_ERROR");
			return _this7;
		}
	...
	exports.MissingAdapterMethods = function(_UnknownError7) {
		function MissingAdapterMethods() {
			...
			(0, _defineProperty2$1.default)(_this8, "name", "MissingAdapterMethodsError");
			(0, _defineProperty2$1.default)(_this8, "code", "MISSING_ADAPTER_METHODS_ERROR");
			return _this8;
		}
	...
	exports.UnsupportedStrategy = function(_UnknownError8) {
		function UnsupportedStrategy() {
			...
			(0, _defineProperty2$1.default)(_this9, "name", "UnsupportedStrategyError");
			(0, _defineProperty2$1.default)(_this9, "code", "CALLBACK_CREDENTIALS_JWT_ERROR");
			return _this9;
		}
	...
	exports.InvalidCallbackUrl = function(_UnknownError9) {
		function InvalidCallbackUrl() {
			...
			(0, _defineProperty2$1.default)(_this10, "name", "InvalidCallbackUrl");
			(0, _defineProperty2$1.default)(_this10, "code", "INVALID_CALLBACK_URL_ERROR");
			return _this10;
		}
	...
	function eventsErrorHandler(methods, logger) {
		return Object.keys(methods).reduce(function(acc, name) {
			acc[name] = (0, _asyncToGenerator2$1.default)(_regenerator$1.default.mark(function _callee() {
	...
	function adapterErrorHandler(adapter, logger) {
		...
		return Object.keys(adapter).reduce(function(acc, name) {
			acc[name] = (0, _asyncToGenerator2$1.default)(_regenerator$1.default.mark(function _callee2() {
...
var require_logger = /* @__PURE__ */ __commonJSMin(((exports) => {
	var _interopRequireDefault$8 = __require("@babel/runtime/helpers/interopRequireDefault");
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = void 0;
	exports.proxyLogger = proxyLogger;
	exports.setLogger = setLogger;
	var _regenerator = _interopRequireDefault$8(__require("@babel/runtime/regenerator"));
	var _defineProperty2 = _interopRequireDefault$8(__require("@babel/runtime/helpers/defineProperty"));
	var _asyncToGenerator2 = _interopRequireDefault$8(__require("@babel/runtime/helpers/asyncToGenerator"));
...
var require_client = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var _openidClient$2 = __require("openid-client");
	async function openidClient(options) {
		const provider = options.provider;
		if (provider.httpOptions) _openidClient$2.custom.setHttpOptionsDefaults(provider.httpOptions);
		let issuer;
		if (provider.wellKnown) issuer = await _openidClient$2.Issuer.discover(provider.wellKnown);
		else {
			var _provider$authorizati, _provider$token, _provider$userinfo;
			issuer = new _openidClient$2.Issuer({
		...
		client[_openidClient$2.custom.clock_tolerance] = 10;
		return client;
	}
}));
...
var require_checks = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var _openidClient$1 = __require("openid-client");
	...
	exports.pkce = {
		async create(options, cookies, resParams) {
			...
			const code_verifier = _openidClient$1.generators.codeVerifier();
			resParams.code_challenge = _openidClient$1.generators.codeChallenge(code_verifier);
	...
	exports.state = {
		async create(options, cookies, resParams) {
			...
			const value = _openidClient$1.generators.state();
	...
	exports.nonce = {
		async create(options, cookies, resParams) {
			...
			const value = _openidClient$1.generators.nonce();
...
var require_callback$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var _openidClient = __require("openid-client");
...
var require_callback = /* @__PURE__ */ __commonJSMin(((exports) => {
	var _interopRequireDefault$7 = __require("@babel/runtime/helpers/interopRequireDefault");
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = callback;
	var _callback = _interopRequireDefault$7(require_callback$1());
	var _callbackHandler = _interopRequireDefault$7(require_callback_handler());
	var _utils = require_utils$1();
	var _getUserFromEmail = _interopRequireDefault$7(require_getUserFromEmail());
...
var require_signin$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	var _interopRequireDefault$6 = __require("@babel/runtime/helpers/interopRequireDefault");
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = signin;
	var _authorizationUrl = _interopRequireDefault$6(require_authorization_url());
	var _signin = _interopRequireDefault$6(require_signin$2());
	var _getUserFromEmail = _interopRequireDefault$6(require_getUserFromEmail());
...
var require_routes = /* @__PURE__ */ __commonJSMin(((exports) => {
	var _interopRequireDefault$5 = __require("@babel/runtime/helpers/interopRequireDefault");
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	var _callback = _interopRequireDefault$5(require_callback());
	var _signin = _interopRequireDefault$5(require_signin$1());
	var _signout = _interopRequireDefault$5(require_signout$1());
	var _session = _interopRequireDefault$5(require_session());
	var _providers = _interopRequireDefault$5(require_providers$1());
}));
var require_signin = /* @__PURE__ */ __commonJSMin(((exports) => {
	var _interopRequireDefault$4 = __require("@babel/runtime/helpers/interopRequireDefault");
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = SigninPage;
	var _preact$3 = __require("preact");
	var _extends2 = _interopRequireDefault$4(__require("@babel/runtime/helpers/extends"));
	...
	function SigninPage(props) {
		...
		return (0, _preact$3.h)("div", { className: "signin" }, theme.brandColor && (0, _preact$3.h)("style", { dangerouslySetInnerHTML: { __html: `
        :root {
          --brand-color: ${theme.brandColor}
        }
      ` } }), theme.buttonText && (0, _preact$3.h)("style", { dangerouslySetInnerHTML: { __html: `
        :root {
          --button-text-color: ${theme.buttonText}
        }
      ` } }), (0, _preact$3.h)("div", { className: "card" }, theme.logo && (0, _preact$3.h)("img", {
			src: theme.logo,
			alt: "Logo",
			className: "logo"
		}), error && (0, _preact$3.h)("div", { className: "error" }, (0, _preact$3.h)("p", null, error)), providersToRender.map((provider, i) => {
			...
			return (0, _preact$3.h)("div", {
				key: provider.id,
				className: "provider"
			}, provider.type === "oauth" && (0, _preact$3.h)("form", {
				...
				name: "csrfToken",
				value: csrfToken
			}), callbackUrl && (0, _preact$3.h)("input", {
				type: "hidden",
				name: "callbackUrl",
				value: callbackUrl
			}), (0, _preact$3.h)("button", {
				type: "submit",
				className: "button",
				style: {
					"--provider-bg": bg,
			...
			}, logo && (0, _preact$3.h)("img", {
				loading: "lazy",
				height: 24,
				width: 24,
				id: "provider-logo",
				src: `${logo.startsWith("/") ? providerLogoPath : ""}${logo}`
			}), logoDark && (0, _preact$3.h)("img", {
				loading: "lazy",
				height: 24,
				width: 24,
				id: "provider-logo-dark",
				src: `${logo.startsWith("/") ? providerLogoPath : ""}${logoDark}`
			}), (0, _preact$3.h)("span", null, "Sign in with ", provider.name))), (provider.type === "email" || provider.type === "credentials") && i > 0 && providersToRender[i - 1].type !== "email" && providersToRender[i - 1].type !== "credentials" && (0, _preact$3.h)("hr", null), provider.type === "email" && (0, _preact$3.h)("form", {
				action: provider.signinUrl,
				method: "POST"
			}, (0, _preact$3.h)("input", {
				type: "hidden",
				...
				id: "submitButton",
				type: "submit"
			}, "Sign in with ", provider.name)), provider.type === "credentials" && (0, _preact$3.h)("form", {
				...
				return (0, _preact$3.h)("div", { key: `input-group-${provider.id}` }, (0, _preact$3.h)("label", {
					className: "section-header",
					htmlFor: `input-${credential}-for-${provider.id}-provider`
				}, (_provider$credentials = provider.credentials[credential].label) !== null && _provider$credentials !== void 0 ? _provider$credentials : credential), (0, _preact$3.h)("input", (0, _extends2.default)({
					name: credential,
			...
			}), (0, _preact$3.h)("button", { type: "submit" }, "Sign in with ", provider.name)), (provider.type === "email" || provider.type === "credentials") && i + 1 < providersToRender.length && (0, _preact$3.h)("hr", null));
		})));
	}
}));
var require_signout = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var _preact$2 = __require("preact");
	function SignoutPage(props) {
		const { url, csrfToken, theme } = props;
		return (0, _preact$2.h)("div", { className: "signout" }, theme.brandColor && (0, _preact$2.h)("style", { dangerouslySetInnerHTML: { __html: `
        :root {
          --brand-color: ${theme.brandColor}
        }
      ` } }), theme.buttonText && (0, _preact$2.h)("style", { dangerouslySetInnerHTML: { __html: `
        :root {
          --button-text-color: ${theme.buttonText}
        }
      ` } }), (0, _preact$2.h)("div", { className: "card" }, theme.logo && (0, _preact$2.h)("img", {
			src: theme.logo,
			alt: "Logo",
			className: "logo"
		}), (0, _preact$2.h)("h1", null, "Signout"), (0, _preact$2.h)("p", null, "Are you sure you want to sign out?"), (0, _preact$2.h)("form", {
			action: `${url}/signout`,
			method: "POST"
		}, (0, _preact$2.h)("input", {
			type: "hidden",
...
var require_verify_request = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var _preact$1 = __require("preact");
	function VerifyRequestPage(props) {
		const { url, theme } = props;
		return (0, _preact$1.h)("div", { className: "verify-request" }, theme.brandColor && (0, _preact$1.h)("style", { dangerouslySetInnerHTML: { __html: `
        :root {
          --brand-color: ${theme.brandColor}
        }
      ` } }), (0, _preact$1.h)("div", { className: "card" }, theme.logo && (0, _preact$1.h)("img", {
			src: theme.logo,
			alt: "Logo",
			className: "logo"
		}), (0, _preact$1.h)("h1", null, "Check your email"), (0, _preact$1.h)("p", null, "A sign in link has been sent to your email address."), (0, _preact$1.h)("p", null, (0, _preact$1.h)("a", {
			className: "site",
			href: url.origin
		}, url.host))));
	}
...
var require_pages = /* @__PURE__ */ __commonJSMin(((exports) => {
	var _interopRequireDefault$3 = __require("@babel/runtime/helpers/interopRequireDefault");
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = renderPage;
	var _preactRenderToString = _interopRequireDefault$3(__require("preact-render-to-string"));
	var _signin = _interopRequireDefault$3(require_signin());
	var _signout = _interopRequireDefault$3(require_signout());
	var _verifyRequest = _interopRequireDefault$3(require_verify_request());
	var _error = _interopRequireDefault$3(require_error());
	var _css = _interopRequireDefault$3(require_css());
...
var require_init = /* @__PURE__ */ __commonJSMin(((exports) => {
	var _interopRequireDefault$2 = __require("@babel/runtime/helpers/interopRequireDefault");
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.init = init;
	var _crypto = __require("crypto");
	var _logger = _interopRequireDefault$2(require_logger());
	var _errors = require_errors();
	var _providers = _interopRequireDefault$2(require_providers());
	var _utils = require_utils$1();
	...
	var _parseUrl = _interopRequireDefault$2(require_parse_url());
	function _getRequireWildcardCache(e) {
		if ("function" != typeof WeakMap) return null;
		var r = /* @__PURE__ */ new WeakMap(), t = /* @__PURE__ */ new WeakMap();
		return (_getRequireWildcardCache = function(e) {
...
var require_assert = /* @__PURE__ */ __commonJSMin(((exports) => {
	var _interopRequireDefault$1 = __require("@babel/runtime/helpers/interopRequireDefault");
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.assertConfig = assertConfig;
	var _errors = require_errors();
	var _parseUrl = _interopRequireDefault$1(require_parse_url());
	var _cookie = require_cookie();
	var warned = false;
...
var require_core = /* @__PURE__ */ __commonJSMin(((exports) => {
	var _interopRequireDefault = __require("@babel/runtime/helpers/interopRequireDefault");
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
export { setHeadersContext as C, setHeadersAccessPhase as S, parseCookieHeader as _, encodeMiddlewareRequestHeaders as a, resolveCallableExport as b, getHeadersContext as c, init_headers as d, init_middleware_request_headers as f, markDynamicUsage as g, isInsideUnifiedScope as h, createRequestContext as i, getRequestContext as l, init_unified_request_context as m, authOptions as n, getAndClearPendingCookies as o, init_parse_cookie_header as p, consumeDynamicUsage as r, getDraftModeCookieHeader as s, applyMiddlewareRequestHeaders as t, headersContextFromRequest as u, require_jwt as v, logger as w, runWithRequestContext as x, require_next_auth as y };
