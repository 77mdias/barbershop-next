...
import { i as __exportAll$1, o as __toESM, t as require_react } from "./react-BoLPyrlK.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/query-z3TAGmwp.js
/**
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/router-DrVx_Z0W.js
var router_DrVx_Z0W_exports = /* @__PURE__ */ __exportAll({
	i: () => wrapWithRouterContext,
	n: () => router_exports,
	r: () => setSSRContext,
	t: () => _registerRouterStateAccessors
});
...
var router_exports = /* @__PURE__ */ __exportAll$1({
	_registerRouterStateAccessors: () => _registerRouterStateAccessors,
	applyNavigationLocale: () => applyNavigationLocale,
	default: () => Router,
	isExternalUrl: () => isExternalUrl,
	isHashOnlyChange: () => isHashOnlyChange,
	setSSRContext: () => setSSRContext,
	wrapWithRouterContext: () => wrapWithRouterContext
});
/**
* next/router shim
*
...
async function navigateClient(url) {
	...
	try {
		...
		const React = (await import("./react-BoLPyrlK.mjs").then((n) => /* @__PURE__ */ __toESM(n.t()))).default;
...
//#endregion
export { addLocalePrefix as a, resolveRelativeHref as c, toSameOriginAppPath as d, urlQueryToSearchParams as f, wrapWithRouterContext as i, stripBasePath as l, router_DrVx_Z0W_exports as n, appendSearchParamsToUrl as o, withBasePath$1 as p, setSSRContext as r, getDomainLocaleUrl as s, _registerRouterStateAccessors as t, toBrowserNavigationHref as u };
