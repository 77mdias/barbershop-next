            ...
            <Card>
              ...
              <CardContent>
                <div className="text-center py-8 text-gray-500">
                  ...
                  <p>Integração com sistema de agendamentos em desenvolvimento</p>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="text-center p-4 bg-yellow-50 rounded-lg border-2 border-yellow-200">
                    ...
                    <p className="text-xs text-yellow-600">Média 4.5+ por 3 meses</p>
                  </div>
                  
                  <div className="text-center p-4 bg-blue-50 rounded-lg border-2 border-blue-200">
                    <UsersIcon className="w-8 h-8 mx-auto text-blue-600 mb-2" />
                    <p className="font-semibold text-blue-800">Client Favorite</p>
                    <p className="text-xs text-blue-600">50+ clientes atendidos</p>
                  </div>
                  
                  <div className="text-center p-4 bg-green-50 rounded-lg border-2 border-green-200">
                    <MessageSquareIcon className="w-8 h-8 mx-auto text-green-600 mb-2" />
                    <p className="font-semibold text-green-800">Review Master</p>
                    <p className="text-xs text-green-600">100+ reviews recebidas</p>
                  </div>
                </div>
              </CardContent>
            </Card>
        ...
        <Card className="border-dashed">
          <CardContent className="pt-6">
            <div className="text-center space-y-2">
              <h3 className="font-semibold">🚀 Dashboard Profissional do Barbeiro</h3>
