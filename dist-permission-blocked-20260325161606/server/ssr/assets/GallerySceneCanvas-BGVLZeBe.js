...
//#region src/components/gallery-3d/GallerySceneCanvas.tsx
...
function SceneObjects({ tier, palette }) {
	...
	return /* @__PURE__ */ jsx(Fragment$1, { children: (tier === "high" ? [
		...
		if (item.kind === "pole") return /* @__PURE__ */ jsx(BarberPole, {
...
function GallerySceneCanvas({ tier, theme, pointerMode }) {
	...
	return /* @__PURE__ */ jsxs(Canvas, {
		...
		children: [
			...
			/* @__PURE__ */ jsx("ambientLight", { intensity: theme === "dark" ? .48 : .44 }),
			...
			/* @__PURE__ */ jsx(MovingFillLight, { color: palette.fillLight }),
